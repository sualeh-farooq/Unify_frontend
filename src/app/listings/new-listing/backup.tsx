...
export default function NewListing() {
    ...
    const [listingPhoto, setListingPhoto] = useState<File[]>([])
    ...
    const [listingForm, setListingForm] = useState({
        ...
        broker: '',
        adTitle: '',
        coverPhoto: null, // Changed to null or an empty string based on your logic
        listingPhoto: null, // Adjust as per your requirements
        agencyAgreement: null, // Adjust as per your requirements
        im: null, // Adjust as per your requirements
        webAd: ''

    })
    const handleFilesUpdate = (event: FileEvent[], setState: React.Dispatch<React.SetStateAction<File[]>>, fieldName: string) => {
    ...
    formData.append('listingPhoto', listingPhoto[0]);
    formData.append('agencyAgreement', agreement[0]);
    formData.append('im', im[0]);
        ...
        <>
            ...
            `}
                                    ...
                                    <div>
                                        ...
                                        <Uploader files={cover} name="coverPhoto" filesUpdate={(event: any) => handleFilesUpdate(event, setCover, 'coverPhoto')} />
                                    </div>
                                    <div>
                                        <label className="mb-3  text-body-md font-bold text-dark dark:text-white">
                                            Listing Photo
                                        </label>
                                        <Uploader files={listingPhoto} name="listingPhoto" filesUpdate={(event: any) => handleFilesUpdate(event, setListingPhoto, 'listingPhoto')} />
                                    ...
                                    <div>
                                        ...
                                        <Uploader files={agreement} name="agencyAgreement" filesUpdate={(event: any) => handleFilesUpdate(event, setAgreement, 'agencyAgreement')} />
                                    ...
                                    <div>
                                        ...
                                        <Uploader files={im} name="im" filesUpdate={(event: any) => handleFilesUpdate(event, setIM, 'im')} />
